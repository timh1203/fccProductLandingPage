  ...
  return (
    <main id="features">
      ...
      <section className="features-blobs">
        <div>
          <img src="/static/blob1.jpg" alt="Keycap Puller" />
          <h3>Included Keycap Puller </h3>
          <p>PICTEK 87-key Mechanical gaming keyboard comes with a keycap puller to help clean the keyboard easier.</p>
        </div>
        <div>
          <img src="/static/blob2.jpg" alt="Ergonomic Design" />
          <h3>Ergonomic Design</h3>
          <p>With keycaps leaning backward and forward design to make the typing more comfortable, the fold-out legs allows you to choose the best typing height.</p>
        </div>
        <div>
          <img src="/static/blob3.jpg" alt="Anti-fading Keycaps" />
          <h3>Fading Resistant Keycaps </h3>
          <p>PICTEK keyboard adopts advanced craft to make sure the letter will not fade, enabling a long service life.</p>
        </div>
        <div>
          <img src="/static/blob4.jpg" alt="Splash Resistsant" />
          <h3>Splash Resistant</h3>
          <p>Splash resistant helps to solve your worry about accident water or tea splash, three hydrophobic holes in the back of the keyboard to accelerate water stream.</p>
        </div>
        <div>
          <img src="/static/blob5.jpg" alt="12 Multimedia Function Keys" />
          <h3>12 Multimedia Function Keys</h3>
          <p>12 Multimedia function keys to enhance efficiency during working on sheet, wps and playing.</p>
        </div>
        <div>
          <img src="/static/blob6.jpg" alt="Lock the Win Key" />
          <h3>Lock the Win Key</h3>
          <p>Pressing the Win and Fn, you will be able to lock the page to help you focus on the game, avoiding page losing.</p>
        </div>
      </section>
    </main>
  )
